...
const envWafEnabled = process.env.WAF_ENABLED;
const enabled = typeof envWafEnabled === "string" ? envWafEnabled === "true" : !isDev;
...
export default {
  ...
  rateLimit: {
    ...
    max: 200, // 1小时最多200次请求
    windowMs: "1h", // 时间窗口
    secretKey: process.env.JWT_SECRET || "DefHB2nSF_J6J", // JWT 密钥（生产环境建议修改）
